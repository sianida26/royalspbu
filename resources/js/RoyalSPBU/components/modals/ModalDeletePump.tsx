...
export default function ModalDeletePump(props: Props) {
    ...
    React.useEffect(() => {
        if (!props.show || props.pump.isNotDefined()){
    ...
    return (
        <Backdrop show={props.show}>
            <div className="tw-bg-white tw-rounded-lg tw-py-4 tw-px-8 tw-w-full tw-max-w-screen-sm tw-flex tw-flex-col tw-items-center">
                ...
                <h1 className="tw-text-center tw-font-bold tw-text-2xl">Yakin ingin menghapus pompa ini ?</h1>
                <p className="tw-my-4 tw-text-gray-700">
                    Pompa yang telah dihapus <b>tidak dapat dikembalikan lagi</b>. Apakah Anda yakin?
                </p>
